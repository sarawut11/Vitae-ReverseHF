...
UniValue getblocktemplate(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            ...
            "        ,...\n"
            "  ],\n"
            "  \"fundamentalnode_payments\" : true|false,         (boolean) true, if masternode payments are enabled\n"
            "  \"enforce_fundamentalnode_payments\" : true|false  (boolean) true, if masternode payments are enforced\n"
            "}\n"
